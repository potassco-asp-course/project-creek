...
To submit your solution, please modify the file [creek.lp](asp/creek.lp) of the directory [asp](asp) with your encoding.
...
* ``python3.6 asp/test.py -e asp/creek.lp -i asp/instances -s asp/solutions -t 180``
